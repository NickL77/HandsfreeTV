...
def listen_print_loop(responses, yt):
    ...
    for response in responses:
        ...
        if not result.is_final:
            ...
            if len(line.split()) > 1 and first_word == 'search':
                yt.search(line.split()[1:])
                print('searching YT')
...
def speech_to_text_thread(yt):
    ...
    with MicrophoneStream(RATE, CHUNK) as stream:
        ...
        listen_print_loop(responses, yt)
